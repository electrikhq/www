...
class BuildLlmsTxt extends Command
{
    ...
    protected function buildIndex(string $base): string
    {
        $lines = [
            ...
            '- [AI & agents]('.$base.'/docs/getting-started/ai): Cursor/Claude with Electrik — AGENTS.md, llms.txt, skills, package-safe rules.',
            '- [AGENTS.md on GitHub](https://github.com/electrikhq/electrik/blob/main/AGENTS.md): Package-root rules for coding agents.',
